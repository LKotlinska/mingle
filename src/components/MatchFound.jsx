  ...
  return (
    <section className="matchSection">
      ...
      <div className="matchContainer">
        <div className="cards">
          <img
            src="/doodlez/doodle-left.png"
            alt=""
            className="doodle doodle--topleft"
          />
          <img
            src="/doodlez/doodle-right.png"
            alt=""
            className="doodle doodle--bottomright"
          />
          <img
          ...
          />
          <MatchCard fileName={"foretag"} cardFor={"företag"} />
          <MatchCard fileName={"kandidat"} cardFor={"kandidat"} />
        </div>
        <h2 className="bestMatch">{best.company.name}</h2>
      </div>
